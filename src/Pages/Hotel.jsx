...
function Hotel() {
  ...
  const Hotel = useSelector((state) => state.getHotel);
        ...
        >
          {show && (
            ...
            >
              ...
              >
                <img
                  src={Hotel.hotel.photos[slideNumber]}
                  alt=""
          ...
          >
            ...
            >
              Excellent location - {Hotel.hotel.distance} from center
            </Typography>
            <Typography
              sx={{
                fontSize: { xs: "12px", md: "15px" },
            ...
            >
              Book a stay over here at ${Hotel.hotel.cheapestPrice} and get a
              free airport taxi
            </Typography>
            {/* hotel images */}
            <Box
            ...
            >
              {Hotel.hotel.photos?.map((photo, idx) => (
            ...
            >
              <Box sx={{ flex: "3", p: 2 }}>
                ...
                >
                  Stay in heart of {Hotel.hotel.city}
                </Typography>
              ...
              >
                ...
                <Typography sx={{ fontSize: { xs: "10px", md: "12px" } }}>
                  Location in real heart of {Hotel.hotel.city}
                </Typography>
