...
function Hotel() {
  ...
  // useEffect(() => {
  //   dispatch(searchState(persistingDDO));
  // }, [dispatch, persistingDDO]);
  ...
  function dayDiff(endDate, startDate) {
    ...
    const dayDiff = Math.ceil(timeDiff / MILLI_SECONDS_PER_DAY);
    return dayDiff;
  }

  const days = Array.isArray(DDOState.date)
    ? dayDiff(DDOState.date[0].endDate, DDOState.date[0].startDate)
    : null;
        ...
        >
          {show && (
            ...
            >
              ...
              >
                <img
                  src={GetHotel.hotel.photos[slideNumber]}
                  alt=""
          ...
          >
            ...
            >
              Excellent location - {GetHotel.hotel.distance} from center
            </Typography>
            <Typography
              sx={{
                fontSize: { xs: "12px", md: "15px" },
            ...
            >
              Book a stay over here at ${GetHotel.hotel.cheapestPrice} and get a
              free airport taxi
            </Typography>
            {/* hotel images */}
            <Box
            ...
            >
              {GetHotel.hotel.photos?.map((photo, idx) => (
            ...
            >
              <Box sx={{ flex: "3", p: 2 }}>
                ...
                >
                  Stay in heart of {GetHotel.hotel.city}
                </Typography>
              ...
              >
                ...
                <Typography sx={{ fontSize: { xs: "10px", md: "12px" } }}>
                  Location in real heart of {GetHotel.hotel.name}
                </Typography>
                <Typography sx={{ fontSize: { xs: "15px", md: "19px" } }}>
                  $
                  {days === 0
                    ? GetHotel.hotel.cheapestPrice
                    : days *
                      GetHotel.hotel.cheapestPrice *
                      DDOState.options.room}{" "}
                  ({days}-nights)
                </Typography>
                <Button
                  onClick={handleClickReserveHotelButton}
